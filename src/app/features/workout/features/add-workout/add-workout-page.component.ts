...
import { AddWorkoutComponent, WorkoutEditorStep } from './add-workout.component';
...
export class AddWorkoutPageComponent {
  ...
  selectedDate = signal(this.getInitialSelectedDate());
  ...
  editingWorkoutId = signal<number | null>(this.getInitialEditingWorkoutId());
  workoutTitle = signal('');
  ...
  saveWorkoutFromSelectedExercises() {
    ...
    if (this.editingWorkoutId() !== null) {
      ...
      this.createWorkoutFromSelectedExercises(selectedExercises);
    }
  ...
  private createWorkoutFromSelectedExercises(selectedExercises: WorkoutExerciseSummary[]) {
  ...
  private getInitialEditingWorkoutId(): number | null {
  ...
  private getWorkoutName(): string {
    return this.workoutTitle().trim() || this.getDefaultWorkoutTitle();
  }
